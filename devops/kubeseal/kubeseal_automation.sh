...
HELM_VALUES_OUTPUT_PATH=devops/helm-chart/values-${ENV_REF}.yaml
...
content = content.replace('prod-opsapi-ui.workstation.co.uk', 'opsapi-ui.workstation.co.uk')
# Write back to file
...
rm -Rf temp.txt
rm -Rf sealed_secret_opsapi_ui_${ENV_REF}.txt
